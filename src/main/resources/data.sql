...
INSERT INTO tb_application_parameters(`id`,`key`,`value`) VALUES(28,'SENDER_CRON_SCHEDULER', '0 */10 * * * *');
INSERT INTO tb_application_parameters(`id`,`key`,`value`) VALUES(29,'ALARMIST_CRON_SCHEDULER', '0 */10 * * * 1-5');
INSERT INTO tb_application_parameters(`id`,`key`,`value`) VALUES(30,'QUEUE_NAME', 'swift_heart_beat_queue');
